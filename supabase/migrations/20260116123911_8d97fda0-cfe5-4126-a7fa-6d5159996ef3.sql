-- Функция триггера синхронизации при отзыве карты
...
-- Привязка триггера
DROP TRIGGER IF EXISTS trigger_sync_payment_method_revocation ON payment_methods;
CREATE TRIGGER trigger_sync_payment_method_revocation
