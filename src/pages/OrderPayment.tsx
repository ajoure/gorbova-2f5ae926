          ...
          <section id="payment-cards" className="mb-12">
            <GlassCard className="p-8">
              ...
              <div className="prose prose-sm max-w-none text-foreground/80 space-y-4">
                <p>
                  Оплата банковскими карточками осуществляется через ЗАО «Альфа-Банк». К оплате принимаются карты международных платежных систем VISA, MasterCard, платежной системы БЕЛКАРТ, платежной системы МИР. Оплату также можно совершить посредством сервисов Apple Pay, Samsung Pay.
                </p>
