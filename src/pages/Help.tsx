...
- Ручная из карточки клиента
  ...
  },
  {
    ...
    requiredPermission: 'roles.manage',
    content: `
**Система закрывающих документов**
Автоматическая генерация счёт-актов для клиентов после оплаты.

**Исполнители (Админка → Исполнители)**
- Управление реквизитами компаний/ИП, от имени которых выставляются документы
- Добавление, редактирование, удаление исполнителей
- Установка исполнителя по умолчанию (используется автоматически)

**Реквизиты клиентов (ЛК → Настройки → Реквизиты)**
Клиенты заполняют свои данные для получения закрывающих документов:
- **Физлицо** — ФИО, паспортные данные, банковские реквизиты
- **ИП** — название, УНП, адрес, свидетельство о регистрации
- **Юрлицо** — название, ОПФ, УНП, должность и ФИО руководителя

**Генерация документов**
1. Клиент оплачивает заказ
2. Система проверяет, заполнены ли реквизиты
3. Если да — генерируется счёт-акт, отправляется на e-mail
4. Документ доступен в разделе «Мои покупки»

**Типы документов**
- **Счёт** — для предоплаты
- **Акт выполненных работ** — после оказания услуги
- **Счёт-акт** — комбинированный документ

**Ручная генерация**
В разделе «Мои покупки» клиент может:
- Скачать счёт (до оплаты)
- Скачать акт (после оплаты)
- Получить чек bePaid
    `
  }
];
...
const faq = [
  ...
  {
    question: 'Как получить закрывающие документы?',
    answer: 'Заполните реквизиты в Настройках → Реквизиты для документов. После этого при каждой оплате счёт-акт автоматически отправляется на ваш e-mail и доступен в разделе «Мои покупки».'
  },
  {
    question: 'Какие реквизиты нужно заполнить?',
    answer: 'Для физлиц — паспортные данные и банковские реквизиты. Для ИП — название, УНП, адрес. Для юрлиц — полное название, УНП, данные руководителя.'
  }
];
